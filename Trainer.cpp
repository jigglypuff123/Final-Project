...
string Trainer::makeMove(stringstream& situation) {
	...
	Class2 c;
	c.getMyCreatures(situation);

	cout << c.getPoke1Name() << " has health of " << c.getPoke1health() << " out of " << c.getPoke1maxHealth() << endl;
	cout << c.getPoke2Name() << " has health of " << c.getPoke2health() << " out of " << c.getPoke2maxHealth() << endl;
	cout << c.getPoke3Name() << " has health of " << c.getPoke3health() << " out of " << c.getPoke3maxHealth() << endl;
	cout << c.getPoke4Name() << " has health of " << c.getPoke4health() << " out of " << c.getPoke4maxHealth() << endl;
